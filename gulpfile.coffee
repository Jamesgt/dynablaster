...
gulp.task 'devServer', ->
	...
	@app.listen 12345
	console.log "Web server listens on http://localhost:12345"
...
gulp.task 'coffee', ->
	gulp.src './src/entryPoint.coffee', read: no
	.pipe addErrorHandler 'CoffeeScript', browserify transform: ['coffeeify']
	.pipe rename 'game.js'
	# .pipe uglify()
	.pipe gulp.dest './dist'
	.pipe livereload()
